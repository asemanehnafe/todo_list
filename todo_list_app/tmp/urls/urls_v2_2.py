...
urlpatterns = [
    ...
    # path('task/<int:task_id>/generate_short_link/', generate_short_link, name='generate_short_link_v2_2'),
    path('task/<int:task_id>/', task_detail_view, name='task_detail_view_v2_2'),
    # path('list/<int:list_id>/task/<int:task_id>/delete_task', delete_task, name='delete_task_v2_2'),
